...
function appearCountries() {
  var countryCircles = document.querySelectorAll('.illustration__country-flag');
  var orbit = document.querySelector('.illustration__country');
  var countries = ['1', '2', '3', '4', '5'];
  var renderCountries = new Promise(function (resolve) {
    setTimeout(function () {
      countryCircles.forEach(function (item, i) {
        setTimeout(function () {
          item.classList.add("illustration__country-flag--active--".concat(countries[i]));
  ...
  renderCountries.then(function () {
    setTimeout(function () {
      orbit.style.animation = 'rotation 20s linear infinite';
      countryCircles.forEach(function (item) {
...
var stopSumb = /[!@#$%^&*()]/;
var searcHeaderInput = document.querySelector('input');
searcHeaderInput.addEventListener('input', function () {
  var valueLength = searcHeaderInput.value.length;
...
fetch('https://baconipsum.com/api/?type=lucky').then(function (resp) {
  return resp.json();
}).then(function (randomtext) {
  setTimeout(function () {
    setInterval(function () {
      var description = document.querySelector('.content-txt__description');
...
var Validator = /*#__PURE__*/function () {
  ...
  _createClass(Validator, [{
    key: "_renderMessage",
    value: function _renderMessage(trigger, parent, item) {
      if (!trigger) {
