...
function appearCountries() {
  var countryCircles = document.querySelectorAll('.circle__country');
  var orbit = document.querySelector('.illustration__circle');
  var countries = ['1', '2', '3', '4', '5'];
  var renderCountries = new Promise(function (resolve) {
    setTimeout(function () {
      countryCircles.forEach(function (item, i) {
        setTimeout(function () {
          item.classList.add("circle__country--active--".concat(countries[i]));
